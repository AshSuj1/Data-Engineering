...
def process_song_file(cur, filepath):
     ...
     """
     Function extracts song data from json files and loads data into song and artist tables
...
def process_log_file(cur, filepath):
    ...
    Function extracts user data from json files and loads data into time, user, songplays tables
...
def process_data(cur, conn, filepath, func):
    ...
    A provided function is used to process data

        Parameters:
        cur: Cursor 
        conn: Connection to the Postgres DB
        filepath: path to json files
        function: function for processing data
